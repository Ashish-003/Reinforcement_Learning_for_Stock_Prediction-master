...
for t in range(l):
		...
		if action == 1: # buy
			...
			number += 1
			print(str(t)+" Buy: " + str(data[t]) + "bleh is " + str(number))
			x_buy.append(t)
			y_buy.append(data[t])
			credit += data[t]
			...
			if profit > 0:
				    winN += 1
			print(str(t)+" Sell: " + str(data[t]) + " | Profit: " + str(data[t] - bought_price) + " bleh 2 isi " + str(number))
			x_sell.append(t)
